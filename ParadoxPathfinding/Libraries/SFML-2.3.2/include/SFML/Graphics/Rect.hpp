...
public:
    ...
    ///
    /// Be careful, the last two parameters are the _width
    /// and _height, not the right and bottom coordinates!
    ///
...
/// its member variables (left, top, _width and _height) are public
...
/// \li The right (left + _width) and bottom (top + _height) edges are excluded from the rectangle's area
///
