...
public:
    ...
    ///
    /// \param function Functor or free function to use as the _entry point of the thread
    ///
    ////////////////////////////////////////////////////////////
    template <typename F>
    Thread(F function);
    ...
    ///
    /// This function starts the _entry point passed to the
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Internal _entry point of the thread
    ///
...
/// function to execute as the _entry point of the thread.
/// sf::Thread has multiple template constructors, which means
/// that you can use several types of _entry points:
