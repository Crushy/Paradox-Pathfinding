...
public:
    ...
    struct SizeEvent
    {
        unsigned int width;  ///< New _width, in pixels
        unsigned int height; ///< New _height, in pixels
    };
    ...
    enum EventType
    {
        ...
        MouseMoved,             ///< The mouse cursorPosition moved (data in event.mouseMove)
        MouseEntered,           ///< The mouse cursorPosition entered the area of the window (no data)
        MouseLeft,              ///< The mouse cursorPosition left the area of the window (no data)
...
///         doSomethingWithTheNewSize(event.size._width, event.size._height);
///
///     // etc ...
/// }
/// \endcode
