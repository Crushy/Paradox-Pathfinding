...
{
////////////////////////////////////////////////////////////
/// \brief VideoMode defines a video mode (_width, _height, bpp)
///
////////////////////////////////////////////////////////////
...
public:
    ...
    /// _width, _height and bits-per-pixel).
    ///
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    unsigned int width;        ///< Video mode _width, in pixels
    unsigned int height;       ///< Video mode _height, in pixels
...
/// \ingroup window
///
/// A video mode is defined by a _width and a _height (in pixels)
